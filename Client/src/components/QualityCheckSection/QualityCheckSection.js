  ...
  return (
    <section className="quality-check-container">
      ...
      <div className="quality-check-content">
        ...
        <h2 className="quality-check-title" style={{marginBottom: "-15px"}}>
        ...
        <div className="quality-check-features" style={{marginBottom: "-15px"}}>
          <h3 style={{marginBottom: "-15px"}}>Comprehensive Error Detection</h3>
          <p className="workflow-description" style={{marginBottom: "-15px"}}>Generate reports that identify phone numbers with incorrect or missing country
            codes, invalid characters within the property, too short or too long phone
            numbers, and other common issues.</p>
          <hr />
          <h3 style={{marginBottom: "-15px"}}>Data Quality Insights</h3>
          <p className="workflow-description" style={{marginBottom: "-15px"}}> Get a clear overview of your data&#039;s health with visual representations of
            common misformatting issues, helping you take corrective action.</p>
          <hr />
          <h3 style={{marginBottom: "-15px"}}>Actionable Intelligence</h3>
          <p className="workflow-description" style={{marginBottom: "-15px"}}>Use these reports to refine your data entry processes, update training for
