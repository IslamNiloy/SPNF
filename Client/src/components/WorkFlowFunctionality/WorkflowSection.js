  ...
  return (
    <section className="workflow-container">
      ...
      <div className="workflow-content">
        ...
        <h2 className="workflow-title_P" style={{marginBottom: "-10px"}}>Workflow <span> &nbsp;Functionality</span></h2>
        ...
        <div className="workflow-features">
          <h3 style={{marginBottom: "-10px"}}>Automated Operations</h3>
          <p className="workflow-description_txt">No more manual phone number formatting—reduce errors and boost HubSpot
          efficiency.</p>
          <hr/>
          <h3 className='workflow-features_h3' style={{marginBottom: "-10px"}}>Customisable Triggers and Actions</h3>
          <p className="workflow-description_txt">Use triggers like new contacts or data imports to format numbers automatically
          in real-time.</p>
          <hr/>
          <h3 className='workflow-features_h3' style={{marginBottom: "-10px"}}>Enhanced Data Consistency</h3>
